...
(function(){
  ...
  async function send(message=''){
    ...
    }catch(error){add('I’m having trouble connecting. You can still use the contact form or call (307) 303-7530.');}
